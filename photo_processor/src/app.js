...
// Import the DynamoDB DocumentClient and the uuid module
const DynamoDBDocClient = new AWS.DynamoDB.DocumentClient({apiVersion: '2012-08-10'});
const uuidv4 = require('uuid/v4');
// Extract the name of the photos table from an environment variable
...
// function to handle putting Photo info into DynamoDB
...
// processRecord() function to pass the metadata and the sizes info to storePhotoInfo()
...
// function to get the metadata for a photo
